...
const ModifyQuestions = ({ onApproved }: Props) => {
  ...
  return (
    <div className="bg-background dark:bg-blue-950 rounded-2xl px-8 py-4 mt-1 lg:mt-4 w-fit mx-auto shadow-md mb-2 lg:mb-4">
      <p className="text-center text-sm font-semibold text-gray-600 dark:text-white mb-3">Use AI to make it</p>

      <div className="flex flex-wrap justify-center gap-3">
        <button
          className="bg-white dark:bg-gray-300 text-gray-500 dark:text-gray-700 text-sm font-bold px-4 py-2 rounded-full shadow-md hover:bg-blue-500 hover:text-white transition"
